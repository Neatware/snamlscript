...
# Date:         5.0 June 6, 2010
#		5.1 Augest 19, 2015
# Description:
# Result:       SNAML for HTML5 I.
# Copyright:    (c)2003-2015, Neatware, All Rights Reserved.
#
# **********************************************************************/
...
#					puts -nonewline $g_channel "<$elem>"
					...
					for {set ii 1} {$ii < [llength $args]} {incr ii} {
						set vv "$vv [lindex $args $ii]"
					}
...
# template
proc _template 								{args}	{ return [Execution $args template 0] }
proc template_								{args}	{
	global g_channel
	global g_string

	Execution $args template 1
	#puts $g_channel "\n"
	outs2 "\n"
	...
	#return [Execution $args template 1]
}

proc __template								{args}	{ return [Execution $args template 2] }
proc _template_								{args}	{ return [Execution $args template 3] }
proc __template_							{args}	{ return [Execution $args template 4] }

proc _TEMPLATE 								{args}	{ return [Execution $args TEMPLATE 0] }
proc TEMPLATE_								{args}	{ return [Execution $args TEMPLATE 1] }
proc __TEMPLATE								{args}	{ return [Execution $args TEMPLATE 2] }
proc _TEMPLATE_								{args}	{ return [Execution $args TEMPLATE 3] }
proc __TEMPLATE_							{args}	{ return [Execution $args TEMPLATE 4] }

# main
proc _main 								{args}	{ return [Execution $args main 0] }
proc main_								{args}	{ return [Execution $args main 1] }
proc __main								{args}	{ return [Execution $args main 2] }
proc _main_								{args}	{ return [Execution $args main 3] }
proc __main_								{args}	{ return [Execution $args main 4] }
...
# SVG
proc _svg 						{args}	{ return [Execution $args svg 0] }
proc svg_						{args}	{ return [Execution $args svg 1] }
proc __svg						{args}	{ return [Execution $args svg 2] }
proc _svg_						{args}	{ return [Execution $args svg 3] }
proc __svg_						{args}	{ return [Execution $args svg 4] }
...
# g
proc _g 						{args}	{ return [Execution $args g 0] }
proc g_							{args}	{ return [Execution $args g 1] }
proc __g						{args}	{ return [Execution $args g 2] }
proc _g_						{args}	{ return [Execution $args g 3] }
proc __g_						{args}	{ return [Execution $args g 4] }
...
# defs
proc _defs 						{args}	{ return [Execution $args defs 0] }
proc defs_						{args}	{ return [Execution $args defs 1] }
proc __defs						{args}	{ return [Execution $args defs 2] }
proc _defs_						{args}	{ return [Execution $args defs 3] }
proc __defs_						{args}	{ return [Execution $args defs 4] }
...
# use
proc _use 						{args}	{ return [Execution $args use 0] }
proc use_						{args}	{ return [Execution $args use 1] }
proc __use						{args}	{ return [Execution $args use 2] }
proc _use_						{args}	{ return [Execution $args use 3] }
proc __use_						{args}	{ return [Execution $args use 4] }
...
# path
proc _path 						{args}	{ return [Execution $args path 0] }
proc path_						{args}	{ return [Execution $args path 1] }
proc __path						{args}	{ return [Execution $args path 2] }
proc _path_						{args}	{ return [Execution $args path 3] }
proc __path_						{args}	{ return [Execution $args path 4] }
...
# text
proc _text 						{args}	{ return [Execution $args text 0] }
proc text_						{args}	{ return [Execution $args text 1] }
proc __text						{args}	{ return [Execution $args text 2] }
proc _text_						{args}	{ return [Execution $args text 3] }
proc __text_						{args}	{ return [Execution $args text 4] }
...
# line
proc _line 						{args}	{ return [Execution $args line 0] }
proc line_						{args}	{ return [Execution $args line 1] }
proc __line						{args}	{ return [Execution $args line 2] }
proc _line_						{args}	{ return [Execution $args line 3] }
proc __line_						{args}	{ return [Execution $args line 4] }
...
# circle
proc _circle 						{args}	{ return [Execution $args circle 0] }
proc circle_						{args}	{ return [Execution $args circle 1] }
proc __circle						{args}	{ return [Execution $args circle 2] }
proc _circle_						{args}	{ return [Execution $args circle 3] }
proc __circle_						{args}	{ return [Execution $args circle 4] }
...
# tspan
proc _tspan 						{args}	{ return [Execution $args tspan 0] }
proc tspan_						{args}	{ return [Execution $args tspan 1] }
proc __tspan						{args}	{ return [Execution $args tspan 2] }
proc _tspan_						{args}	{ return [Execution $args tspan 3] }
proc __tspan_						{args}	{ return [Execution $args tspan 4] }
...
# mask
proc _mask 						{args}	{ return [Execution $args mask 0] }
proc mask_						{args}	{ return [Execution $args mask 1] }
proc __mask						{args}	{ return [Execution $args mask 2] }
proc _mask_						{args}	{ return [Execution $args mask 3] }
proc __mask_						{args}	{ return [Execution $args mask 4] }
